const products = [
  ...
  },
  {
    ...
    description:
      "Feature-rich smartwatch with fitness tracking, heart rate monitor, and smartphone notification. Water-resistant design.",
  },
  {
    id: 3,
    name: "Laptop Stand",
    ...
    description:
      "Ergonomic aluminium laptop stand that improves posture and workspace organization. Adjustable height and angle.",
  },
  {
    id: 4,
    ...
    description:
      "RGB backlist mechanical keyboard with Cherry MX switches. Perfect for gaming and typing enthusiasts.",
  },
  {
    id: 5,
    name: "USB-C Hub",
